...
CREATE USER LAB02 IDENTIFIED BY LAB02;
GRANT LAB02, RESOURCE TO LAB02 WITH ADMIN OPTION;
GRANT CREATE SESSION TO LAB02;
GRANT ALL PRIVILEGES TO LAB02;
GRANT DBA TO LAB02;
GRANT EXEMPT ACCESS POLICY TO LAB02;

-- connect sys as sysdba (sqlplus)
-- grant execute on sys.dbms_crypto to LAB02;
